...
def summarize_text(text, summarization_pipeline):
    ...
    input = prompt + text
    #input = prompt
    summary = summarization_pipeline(input, do_sample=False, truncation=True)
...
file_paths = ["/scratch/work/koshevv1/Contract-analysis-with-LLM/NDA1.txt", 
              "/scratch/work/koshevv1/Contract-analysis-with-LLM/NDA2.txt"]
